...
def encode(allCommands):
    ...
    for command in allCommands:
        if (command["type"] == "S"):
            data.append(str(command["type"]) + str(command["x"]).zfill(5) + str(command["y"]).zfill(5) + str(int(command["burning"])) + str(command["rotation"]).zfill(3))
        elif (command["type"] == "L"):
            data.append(str(command["type"]) + str(command["name"]) + str(command["x"]).zfill(5) + str(command["y"]).zfill(5) + str(int(command["burning"])) + str(command["rotation"]).zfill(3))
        elif (command["type"] == "E"):
            data.append(str(command["type"]) + str(command["x"]).zfill(5) + str(command["y"]).zfill(5))
        else:
